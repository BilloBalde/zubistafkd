...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Reglages Emails</h4>
            <h6>Gerer vos Reglages Emails</h6>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                        <label>Mail Mailer <span class="manitory">*</span></label>
                        <input type="text">
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                        <label>Mail Username<span class="manitory">*</span></label>
                        <input type="text">
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
